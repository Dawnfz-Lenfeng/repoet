from typing import Optional, Iterator, Union, overload, Pattern as RePattern, Match
...
class Pattern:
    ...
    def subn(self, repl: Union[str, callable], string: str, count: int = ...) -> tuple[str, int]: ...
